...
<section id="about" class="site-padding">
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                <?php
                $sql = "SELECT * FROM secrets ORDER BY RAND() LIMIT 1";
                $result = $conn->query($sql);

                if ($result->num_rows > 0) {
                    if ($row = $result->fetch_assoc()) {
                        echo "<div class='about-text wow fadeInLeft'>" . $row['secret'] . "</div>";
                        echo "<div class='about-text wow fadeInLeft'>" . $row['username'] . "</div>";
                    }
                }
                ?>
            </div>
